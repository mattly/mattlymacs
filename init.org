     ...
     (defun +org|init-keybinds ()
       ...
       (map! (:map org-mode-map
	     ...
	     (:map org-mode-map
	       ...
	       (:leader
		 (:desc "structural (org)" :prefix "k"
		   :desc "nav/ parent" :nv "H" #'outline-up-heading
		   :desc "mod/ promote subtree" :nv "H" #'org-promote-subtree
		   :desc "nav/ previous visible heading" :nv "k" #'org-previous-visible-heading
		   :desc "mod/ move subtree up" :nv "K" #'org-move-subtree-up
		   :desc "nav/ next visible heading" :nv "j" #'org-next-visible-heading
		   :desc "mod/ move subtree down" :nv "J" #'org-move-subtree-down
		   :desc "mod/ demote subtree" :nv "L" #'org-demote-subtree
		   ;; :desc "nav/ next header same level" :nv "n" #'org-forward-same-level
		   :desc "mod/ promote current" :nv "N" #'org-do-promote
		   ;; :desc "nav/ previous header same level" :nv "p" #'org-backward-same-level
		   :desc "mod/ demote current" :nv "P" #'org-do-demote
		   :desc "vis/ hoist subtree" :nv "h" #'org-narrow-to-subtree
		   :desc "vis/ unhoist subtree" :nv "H" #'widen))

	       (:localleader
		 :desc "edit special" :n "c" #'org-edit-special
		 :desc "insert heading after" :n "h" #'org-insert-heading-respect-content
		 :desc "insert link" :nv "l" #'org-insert-link))))
   #+END_SRC
