...
** Menu System
   ...
   #+BEGIN_SRC emacs-lisp 
     (general-mmap
      ...
      ;; "y" '(:ignore t :which-key "fold")
      "y" '(mattly|folding/body :which-key "folding")
      ;; "ya" '(origami-forward-toggle-node :which-key "toggle-at-point")
      ;; "yA" '(origami-toggle-all-nodes :which-key "toggle ALL") 
      ;; "yc" '(origami-close-node :which-key "close at point")
      ;; "yC" '(origami-close-node-recursively :which-key "close recursively")
      ;; "yo" '(origami-open-node :which-key "open at point")
      ;; "yO" '(origami-open-node-recursively :which-key "open recursively")
      ;; "ym" '(origami-open-all-nodes :which-key "open ALL")
      ;; "yr" '(origami-close-all-nodes :which-key "close ALL")
      ;; "yp" '(origami-previous-fold :which-key "goto previous")
      ;; "yn" '(origami-next-fold :which-key "goto next")
