...
*** Binding Helpers
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (general-create-definer bind-navigation-for-maps
                              :states '(evil-normal-state-map evil-visual-state-map evil-motion-state-map))
      ...
      (general-create-definer bind-modifier-for-maps
                              :states '(evil-normal-state-map evil-visual-state-map))
...
** Bindings
   #+BEGIN_SRC emacs-lisp
     (bind-navigation-for-maps
      ...
      "N" 'evil-cp-backward-sexp
      "I" 'evil-cp-forward-sexp
      "U" 'evil-cp-backward-up-sexp
      "E" 'evil-cp-next-opening)
   #+END_SRC
...
*** Navigation
    #+BEGIN_SRC emacs-lisp
      (bind-navigation
       ...
       "k" 'evil-avy-find-char
       "K" 'evil-avy-find-char-to
