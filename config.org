   ...
   #+BEGIN_SRC emacs-lisp
     (use-package persp-mode
       ...
       (setq persp-autokill-buffer-on-remove 'kill-weak
             ...
             persp-remove-buffers-from-nil-persp-behavior nil
             persp-init-frame-behavior t
             persp-init-new-frame-behavior-override 'auto-temp
...
*** Navigation
    #+BEGIN_SRC emacs-lisp
      (bind-navigation
       ...
       "m" '(:ignore t :which-key "fold")
       "m c" '(origami-close-node :which-key "close")
       "m C" '(origami-close-node-recursively :which-key "close recursively") 
       "m m" '(origami-forward-toggle-node :which-key "toggle")
       "m M" '(origami-toggle-all-nodes :which-key "toggle recursively")
       "m o" '(origami-open-node :which-key "open")
       "m O" '(origami-open-node-recursively :which-key "open recursively")
       "m a" '(origami-open-all-nodes :which-key "open all")
       "m A" '(origami-close-all-nodes :which-key "close all")
       "m e" '(origami-next-fold :which-key "go next")
       "m u" '(origami-previous-fold :which-key "go previous")
...
*** Modification
    #+BEGIN_SRC emacs-lisp
      (bind-modifier
       ...
       "w c" '(evil-commentary :which-key "comment (operator)")
       "w s" '(evil-surround-edit :which-key "comment (operator)"))
      ...
      (bind-visual
       ...
       "Z" 'evil-visual-exchange-corners)
    #+END_SRC
*** Et Cetera
    #+BEGIN_SRC emacs-lisp
      (bind-navigation
